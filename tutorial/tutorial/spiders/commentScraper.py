...
class ProductSpider(BaseSpider):
    name = "paginated_comments"
    allowed_domains = ['www.theguardian.com']
    start_urls = ['http://www.theguardian.com/us-news/2014/nov/20/obama-plan-shield-five-million-undocumented-migrants-deportation-speech']
