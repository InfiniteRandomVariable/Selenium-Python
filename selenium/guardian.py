...
import guardian_comment, timeHelper, common_classes, jsonHelper, re, imageUtil, time, articleUtil
...
class PythonOrgSearch(unittest.TestCase):
    ...
    def test_search_in_python_org(self):
        ...
        for page in pages[:]:
            ...
            if isSuccess and articleUtil.checkArticle(thePage):
                print("added")
                rowElements.append(thePage)
            else:
                print("Fail to add: {0}".format(thePage.url))
